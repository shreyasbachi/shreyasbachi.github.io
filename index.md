...
<div class="profile-section">
    <img src="files/shreyas_picture.JPG" alt="Shreyas Bachiraju" class="profile-img" />
...
<div style="text-align: center; margin: 2rem 0;">
    <img src="/files/semantic-seg.gif" alt="Urban Semantic Segmentation" style="max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);" />
    <p style="font-size: 0.9rem; color: #666; margin-top: 0.5rem;"><em>Semantic segmentation for urban density understanding (U-Plan)</em></p>
</div>
